...
$args = array(
	...
	'menu_title'                => esc_html__( ' قالب یکتامحصول', 'your-textdomain-here' ),
	'page_title'                => esc_html__( ' قالب یکتامحصول', 'your-textdomain-here' ),
...
if ( false !== $args['global_variable'] ) {
	...
	$args['intro_text'] = '<p>' . sprintf( __( 'از این قسمت میتوانید قالب خود را ویرایش کنید', 'your-textdomain-here' ) . '</p>', '<strong>' . $v . '</strong>' );
} else {
...
$section = array(
	'title'  => esc_html__( 'تنظیمات اولیه', 'your-textdomain-here' ),
	'id'     => 'basic',
	'desc'   => esc_html__( 'تنظیمات اولیه.', 'your-textdomain-here' ),
	'icon'   => 'el el-home',
	'fields' => array(
		array(
			'id'       => 'opt-text',
			'type'     => 'text',
			'title'    => esc_html__( 'نام قالب:', 'your-textdomain-here' ),
...
$section = array(
	'title' => __( 'تنظیمات اولیه', 'your-textdomain-here' ),
	'id'    => 'basic',
	'desc'  => __( 'تنظیمات اولیه as subsections.', 'your-textdomain-here' ),
	'icon'  => 'el el-home',
);
...
$section = array(
	'title'      => esc_html__( 'متن', 'your-textdomain-here' ),
	...
	'fields'     => array(
		array(
			'id'       => 'text-example',
			'type'     => 'text',
			'title'    => esc_html__( 'متن تست 2', 'your-textdomain-here' ),
			'subtitle' => esc_html__( 'ششششششششش', 'your-textdomain-here' ),
...
$section = array(
	'title'      => esc_html__( 'درباره ما', 'your-textdomain-here' ),
...
$section = array(
	'title'  => esc_html__( 'تنظیمات 2', 'your-textdomain-here' ),
	'id'     => 'basic2',
	'desc'   => esc_html__( 'تنظیمات 2.', 'your-textdomain-here' ),
	'icon'   => 'el el-home',
	'fields' => array(
		array(
			'id'       => 'opt-text',
