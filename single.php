                    ...
                    <div class="bg-package d-flex align-items-center justify-content-center">
                        <div class="breadcrumb radius15">
                            <ul class="">
                                ...
                                <li><a href="<?php the_permalink();?>" class="current"> <?php  the_title();?></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
foreach ($categories as $category) {
    echo '<li><a href="' . get_category_link($category->term_id) . '">' . $category->name . '</a><br><a href="'.  get_category_link($category->term_id).'"> <div class="arrow-cat d-flex align-items-center justify-content-center">
...
$related_posts = get_posts(array(
    'post_type' => 'post',
    'posts_per_page' => 5, // تعداد پست‌های مشابه که می‌خواهید نمایش داده شود
    'post__not_in' => array(get_the_ID()), // برای اینکه پست فعلی در نتایج نمایش داده نشود
    'category__in' => wp_get_post_categories(get_the_ID()), // بر اساس دسته‌بندی‌های پست فعلی
));
            ...
            <div class="col-xl-9 order-xl-0 pl-4 order-0 mb-3 blog-p">
                    ...
                    <div class="mb-3 p-3">
                        ...
                        <div class="op p_relative">
                            <img src="<?php the_post_thumbnail_url();?>" alt="" class="img-fluid mb-4 blogimg radius30" />
                            <div class="op-description d-flex justify-content-between w-100">
                                <h3><?php the_title();?></h3>

                                <div class="d-flex align-items-center">   
                                    <p class="ml-2"><?php if(function_exists('the_views')) { the_views(); } ?></p>
