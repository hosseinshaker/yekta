                            ...
                            <div>
                                <div class="row">
                                    <div class="col-lg-4 col-md-5 col-sm-6 d-flex align-items-center pic-product">
                                        <div class="white-box text-center"><img src="<?php the_post_thumbnail_url();?>" class="img-responsive"></div>
                                    </div>
                                    <div class="col-lg-8 col-md-7 col-sm-6 ">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li class="color-gray">توضیحات محصول: <p class="color-dark"><?php echo get_the_content();?></p></li>
